...
class Maps:
    ...
    def draw_map(self):
        ...
        if self.level == 1:
            for i in range(3):
                new_bird = calculation.Bird(40*i + 5*i, height - 40, 20, None, "BIRD")
                birds.append(new_bird)

            pigs.append(calculation.Pig(1100, height - 40, 20))
            pigs.append(calculation.Pig(1500, height - 40, 20))

            blocks.append(calculation.Block(1300, height - 60, 60))
            ...
            pigs.append(calculation.Pig(1000, height - 40, 20))
            pigs.append(calculation.Pig(1400, height - 40, 20))

            blocks.append(calculation.Block(1200, height - 60, 60))
            blocks.append(calculation.Block(1200, height - 2*35, 60))
            blocks.append(calculation.Block(1500, height - 60, 60))
            ...
            pigs.append(calculation.Pig(1200, height - 60, 30))
            pigs.append(calculation.Pig(1300, height - 60, 30))

            blocks.append(calculation.Block(1000, height - 100, 100))
            blocks.append(calculation.Block(1000, height - 2*60, 100))
            blocks.append(calculation.Block(1500, height - 100, 100))
            blocks.append(calculation.Block(1500, height - 2*60, 100))
            ...
            pigs.append(calculation.Pig(1200, 500 - 60, 30))
            pigs.append(calculation.Pig(1300, height - 60, 30))

            walls.append(objects.Slab(1000, 450, 500, 20))

            blocks.append(calculation.Block(1100, height - 100, 100))
            ...
            pigs.append(calculation.Pig(1300, 500 - 60, 25))
            pigs.append(calculation.Pig(1300, height - 60, 25))

            walls.append(objects.Slab(500, 400, 100, height - 400))
            walls.append(objects.Slab(1000, 450, 500, 30))

            blocks.append(calculation.Block(1150, 500 - 100, 100))
            blocks.append(calculation.Block(1100, height - 100, 100))
            ...
            pigs.append(calculation.Pig(1100, 500 - 60, 25))
            pigs.append(calculation.Pig(1300, 500 - 60, 25))
            pigs.append(calculation.Pig(1200, height - 60, 25))
            ...
            pigs.append(calculation.Pig(1100, height - 60, 25))
            pigs.append(calculation.Pig(1200, height - 60, 25))
            ...
            pigs.append(calculation.Pig(1100, height - 60, 25))
            pigs.append(calculation.Pig(1450, height - 60, 25))


            blocks.append(calculation.Block(1250, height - 100, 100))
            blocks.append(calculation.Block(1250, height - 2*60, 100))
            ...
            blocks.append(calculation.Block(1250, height - 100, 100))
            blocks.append(calculation.Block(1250, height - 2*60, 100))
            blocks.append(calculation.Block(900, height - 100, 100))
            ...
            pigs.append(calculation.Pig(1100, height - 60, 25))
            pigs.append(calculation.Pig(1200, 400 - 60, 25))
            pigs.append(calculation.Pig(1450, height - 60, 25))

            blocks.append(calculation.Block(900, height - 100, 100))
            blocks.append(calculation.Block(900, height - 2*60, 100))
            ...
            pigs.append(calculation.Pig(1100, height - 60, 25))
            pigs.append(calculation.Pig(1100, 400 - 60, 25))
            pigs.append(calculation.Pig(1450, height - 60, 25))

            blocks.append(calculation.Block(900, height - 100, 100))

            blocks.append(calculation.Block(1300, 400 - 100, 100))
            ...
            pigs.append(calculation.Pig(900, height - 60, 25))
            pigs.append(calculation.Pig(width - 400, 400 - 60, 25))
            pigs.append(calculation.Pig(1700, height - 60, 25))
    ...
    def start_level(self, birds, pigs, blocks, walls):
        ...
        slingshot = calculation.Slingshot(200, height - 200, 30, 200)
        ...
        birds_remaining.add_text("DOGS REMAINING: " + str(len(birds)), 25, "Fonts/Comic_Kings.ttf", (236, 240, 241))

        pigs_remaining = interface.Label(110, 90, 100, 50, None, self.color['background'])
        pigs_remaining.add_text("CATS REMAINING: " + str(len(pigs)), 25, "Fonts/Comic_Kings.ttf", (236, 240, 241))
        ...
        while loop:
            ...
            for i in range(len(pigs)):
                for j in range(len(blocks)):
                    ...
                    pigs[i], blocks[j], result_block_pig = calculation.collision_handler(pigs[i], blocks[j], "BALL_N_BLOCK")
            ...
            for i in range(len(birds)):
                if not (birds[i].loaded or birds[i].velocity.magnitude == 0):
                    for j in range(len(blocks)):
                        ...
                        birds[i], blocks[j], result_bird_block = calculation.collision_handler(birds[i], blocks[j], "BALL_N_BLOCK")
            ...
            for i in range(len(pigs)):
                ...
                for j in range(i+1, len(pigs)):
                    ...
                    pigs[i], pigs[j], result = calculation.collision_handler(pigs[i], pigs[j], "BALL")
            ...
            for i in range(len(birds)):
                if (not birds[i].loaded) and birds[i].velocity.magnitude:
                    ...
                    for j in range(len(pigs)):
                        ...
                        birds[i], pigs[j], result_bird_pig = calculation.collision_handler(birds[i], pigs[j], "BALL")
            ...
            for i in range(len(blocks)):
                for j in range(i + 1, len(blocks)):
                    ...
                    blocks[i], blocks[j], result_block = calculation.block_collision_handler(blocks[i], blocks[j])
